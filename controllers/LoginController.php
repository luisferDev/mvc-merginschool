...
class LoginController {
    ...
    public function login() {
        ...
        //recuperar el usuario (o email) y la clave
        $u = DB::escape($_POST['usuario']);
        $c = md5($_POST['clave']); // la clave en MD5
    ...
    // LOGOUT --------------------------------
    // método que gestiona la salida del usuario de la app
    public function logout() {
        
        //elimina los datos de sesión y desvincular el usuario
        Login::clear();
